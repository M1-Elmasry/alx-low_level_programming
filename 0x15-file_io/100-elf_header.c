 ...
 * @e_ident: the pointer that conataining the elf magic numbers.
 * Return: void
 */
...
/**
 * print_magic - the function that prints the magic number of an ELF header.
 * @e_ident: the pointer that containing the elf magic numbers.
 * Return: void
 */
...
/**
 * main - Displays the information of ELF header in an ELF file.
